//The bar graph controller loads data from the Open Baltimore cite and loops through both the Library and Museum data sets
//to determine the count of each per Baltimore police district. After the counts are set in the musData and libData arrays,
//a chart.js Chart object is created using the arrays and the 'bar' tag, and the bar graph is passed on to View 3 (Visualize) 
//via the $scope variable


appMod.controller("BarGraphController", function ($scope) { 
